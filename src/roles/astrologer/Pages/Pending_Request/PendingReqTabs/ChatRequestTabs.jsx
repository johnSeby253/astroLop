                ...
                <div key={request.id} className="w-full max-w-md p-4 bg-white rounded-3xl shadow-card flex flex-col gap-4">
                    ...
                    <div className="flex justify-between items-start gap-4">
                        ...
                        <div className="flex flex-col items-end gap-2">
                                ...
                                <div className="text-[#0A64E2] bg-[#BDEFFF] text-sm font-medium font-inter rounded-full px-4 py-1 flex items-center justify-center gap-2">
...
export default ChatRequestTabs
