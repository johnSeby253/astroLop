import { BadgeIndianRupee,MessageSquare, Phone, Star } from 'lucide-react'
            ...
            <div className="w-full h-full hidden lg:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-[#FFFFFF] rounded-xl shadow-[0px_4px_10.5px_rgba(58,58,58,0.27)] px-5 py-8 flex flex-col gap-6">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[#555555] font-inter text-sm font-medium">Total Consultation</span>
                    </div>

                    <div className="flex items-center justify-between">
                        <h2 className="text-2xl font-semibold font-urbanist text-[#000000]">156</h2>
                ...
                <div className="bg-[#FFFFFF] rounded-xl shadow-[0px_4px_10.5px_rgba(58,58,58,0.27)] px-5 py-8 flex flex-col gap-6">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[#555555] font-inter text-sm font-medium"> Pending Consultation</span>
                    </div>
                ...
                <div className="bg-[#FFFFFF] rounded-xl shadow-[0px_4px_10.5px_rgba(58,58,58,0.27)] px-5 py-8 flex flex-col gap-6">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[#555555] font-inter text-sm font-medium">Total Completed</span>
                    </div>
