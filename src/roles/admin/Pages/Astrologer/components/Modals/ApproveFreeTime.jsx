...
const ApproveFreeTime = ({ open, setOpen, expert }) => {
    ...
    return (
        ...
        >
            <div className="flex flex-col gap-6">
                <p className='text-primary font-urbanist text-[20px] font-bold leading-normal'>Verify expert & set free time </p>

                {/* Profile Image */}
                <div className="flex items-center justify-center">
                    <img src={expert?.avatar} className='w-28 h-28 rounded-full' alt="" />
                </div>
                ...
                <div className="flex items-center justify-between border border-border-line px-5 py-4 rounded-lg">
                    ...
                    <div className="flex flex-col gap-3 items-end">
                        <p className="text-[#090909] font-inter text-[14px] font-semibold">
...
export default ApproveFreeTime
